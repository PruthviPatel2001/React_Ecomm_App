...
const PaymentForm = ({ checkoutToken, shippingData, backStep, onCaptureCheckout, nextStep, timeout }) => {
    ...
    const handleSubmit = async (event, elements, stripe) => {
        ...
        if (error) {
            ...
            const orderData = {
                line_items: checkoutToken.live.line_items, //add  .live
                ...
                payment: {
                    gateway: 'stripe',
                    stripe: {
                        payment_mehtod_id: paymentMethod.id,
                    },
                },
            };
                
            // onCaptureCheckout(checkoutToken.id, orderData); {use when credit card is been added in commerce.js}
